...
TYPE_C_ATTACK = False
# Default to "gross" out-of-band value; override via PROJECT5_MALICIOUS_SP for
# stealthy in-band attacks (e.g. 2.5 pu stays inside tier-1 band but trips tier-2).
try:
    MALICIOUS_SETPOINT = float(os.environ.get("PROJECT5_MALICIOUS_SP", "8.0"))
except ValueError:
